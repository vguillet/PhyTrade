...
from src.Trade_simulations.Building_blocks.Portfolio import Portfolio
...
class RUN_multi_trade_sim:
    def __init__(self):
        ...
        while self.ref_data_slice.end_of_dataset is False:
            ...
            # --> Throttle values
            # Account stop-losses
            self.current_account_prev_stop_loss = round(throttle(current_iteration=data_slice_count,
            ...
            self.current_account_max_stop_loss = round(throttle(current_iteration=data_slice_count,
                                                                nb_of_iterations=self.nb_data_slices,
            ...
            # Ticker stop-losses
            self.current_ticker_prev_stop_loss = round(throttle(current_iteration=data_slice_count,
                                                                nb_of_iterations=self.nb_data_slices,
            ...
            self.current_max_investment_per_trade = round(throttle(current_iteration=data_slice_count,
                                                                   nb_of_iterations=self.nb_data_slices,
        ...
        self.results.subslice_size = subslice_size
...
class Trade_simulation_results_gen:
    ...
    def gen_result_recap_file(self):
        ...
        self.results_file.write("subslice_size = " + str(self.subslice_size) + "\n")
