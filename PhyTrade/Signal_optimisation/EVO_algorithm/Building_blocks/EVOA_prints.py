...
class EVOA_prints:
    def __init__(self, ticker, evoa_version, settings):
        ...
        if self.settings.signal_tuning_settings.multiprocessing:
            ...
            self.generation_info = self.__monkey_patch_pass
            self.end_of_optimisation_msg = self.__monkey_patch_pass
            self.init_pop_success_msg = self.__monkey_patch_pass
            self.exploration_phase_complete_msg = self.__monkey_patch_pass
            self.det_new_generation_param_msg = self.__monkey_patch_pass
            self.select_ind_msg = self.__monkey_patch_pass
            self.gen_offsprings_msg = self.__monkey_patch_pass
            self.darwin_in_charge_msg = self.__monkey_patch_pass
            self.eval_pop_msg = self.__monkey_patch_pass
            self.invalid_slice_msg = self.__monkey_patch_pass
