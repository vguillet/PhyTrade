...
class Individual:
    def __init__(self):
        ...
        self.sma_1_timeperiod_2 = self.ga_random.timeframe_random_gen()

        self.sma_2_timeperiod_1 = self.ga_random.timeframe_random_gen()
        self.sma_2_timeperiod_2 = self.ga_random.timeframe_random_gen()

        self.sma_3_timeperiod_1 = self.ga_random.timeframe_random_gen()
        self.sma_3_timeperiod_2 = self.ga_random.timeframe_random_gen()

        self.sma_1_spline_smoothing_factor = self.ga_random.smoothing_factor_random_gen()
        ...
        self.rsi_2_spline_weight = self.ga_random.weight_random_gen()
        self.rsi_3_spline_weight = self.ga_random.weight_random_gen()

        self.sma_1_spline_weight = self.ga_random.weight_random_gen()
        self.sma_2_spline_weight = self.ga_random.weight_random_gen()
        self.sma_3_spline_weight = self.ga_random.weight_random_gen()
